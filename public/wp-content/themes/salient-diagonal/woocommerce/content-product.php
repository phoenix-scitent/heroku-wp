...
<li <?php post_class( $classes ); ?>>
	...
	<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
		...
		<?php
			...
			propel_product_category_icons_list_html( $product ); // to link, provide a second param. eg: 
			// propel_product_category_icons_list_html( $product, '/course-catalog/' );
			// for names, use the _names_ function: 
			// propel_product_category_names_list_html( $product, '/course-catalog/' );
?>
