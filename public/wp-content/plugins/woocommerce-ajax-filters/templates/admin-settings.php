            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span style="color:#666666;margin-left:2px;"><?php _e('Hide values without products ( `Show all values` should be enabled )', BeRocket_AJAX_domain) ?></span><br>
                    ...
                    <tr class="br_checkbox_radio_settings">
                        ...
                        <td class="admin-column-color">
                            <select name="br_filters_options[styles_input][radio][theme]" class="br_theme_set_select">
                                ...
                                <option data-border_color="" data-border_width="" data-border_radius="" data-size="" data-font_color="33dd33" data-background="333333" data-icon="f111" value="green_1"<?php if ( @ $options['styles_input']['radio']['theme'] == 'green_1' ) echo ' selected' ?>>Green 1</option>
        ...
        <div class='berocket_aapf_advanced_settings'>
            ...
            <div class="br_aapf_child_parent_selector" style='display: none;'>
                ...
                <p class="berocket_aapf_widget_child_parent_depth_block" style="display: none;">
                    <label for="berocket_sc_child_parent_depth" class="br_admin_full_size"><?php _e('Child depth', BeRocket_AJAX_domain) ?></label>
                    <input id="berocket_sc_child_parent_depth" data-sc_change="0" data-sc="child_parent_depth" type="number" min="1" value="1">
                </p>
            </div>
        </div>
    </div>
