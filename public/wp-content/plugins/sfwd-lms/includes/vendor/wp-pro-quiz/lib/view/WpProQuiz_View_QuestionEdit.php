		...
		<table style="width: 100%;border: 1px solid #9E9E9E;border-collapse: collapse; margin-bottom: 20px;">
			<thead>
				<tr>
					...
					<!-- new field for answer hint for single choice questions. -->
					<th style="padding: 5px;"><?php _e('Answer Hint', 'wp-pro-quiz'); ?></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td style="padding: 5px; vertical-align: top;">
						<textarea rows="2" cols="65" class="large-text wpProQuiz_text" name="answerData[][answer]" style="resize:vertical;"><?php echo $d->getAnswer(); ?></textarea>
					</td>
					
					<td style="padding: 5px; vertical-align: top;">
						<textarea rows="2" cols="35" class="large-text wpProQuiz_text" name="answerData[][answer_hint]" style="resize:vertical;"><?php echo $d->getAnswerHint(); ?></textarea>
					</td>
				</tr>
			</tbody>
		</table>
