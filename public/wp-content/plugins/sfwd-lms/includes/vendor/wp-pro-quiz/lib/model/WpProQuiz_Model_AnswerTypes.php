...
class WpProQuiz_Model_AnswerTypes extends WpProQuiz_Model_Model {
	...
	/* By Bharat
	 * custom code to add answer hint feature
	 * handles the answer hint added by user for each specific answer & saves in DB.
	 */
	public function setAnswerHint($_answerhint){
		$this->_answerhint = (string)$_answerhint;
		return $this;
	}
	
	public function getAnswerHint(){
		return $this->_answerhint;
	}
	/*custom code ends */
