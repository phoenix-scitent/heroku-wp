...
class WC_PS_All_Results_Page_Settings extends WC_Predictive_Search_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'All Results Pages successfully saved.', 'woops' ),
				'error_message'		=> __( 'Error: All Results Pages can not save.', 'woops' ),
				'reset_message'		=> __( 'All Results Pages successfully reseted.', 'woops' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'All Results Pages', 'woops' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				...
				'desc' 		=> __('The number of results to show before endless scroll click to see more results.', 'woops'),
			...
			array(  
				'name' 		=> __( 'Description character count', 'woops' ),
				'desc' 		=> __('The number of characters from product descriptions that shows with each search result.', 'woops'),
			...
			array(  
				'name' 		=> __( 'Product Categories', 'woops' ),
