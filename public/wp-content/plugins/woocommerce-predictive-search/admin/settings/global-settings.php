	...
	public function init_form_fields() {
		...
		if ( is_admin() && in_array (basename($_SERVER['PHP_SELF']), array('admin.php') ) && isset( $_GET['page'] ) && $_GET['page'] == 'woo-predictive-search' && ( ! isset( $_GET['tab'] ) || $_GET['tab'] == 'global-settings' ) ) {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
     		...
     		array(
            	'name' 		=> __( 'Plugin Framework Global Settings', 'woops' ),
           	...
           	array(
           		'name'		=> __( 'Customize Admin Setting Box Display', 'woops' ),
           		'desc'		=> __( 'By default each admin panel will open with all Setting Boxes in the CLOSED position.', 'woops' ),
                'type' 		=> 'heading',
           	),
           	array(
			...
			array(
           		'name'		=> __( 'Google Fonts', 'woops' ),
           		'desc'		=> __( 'By Default Google Fonts are pulled from a static JSON file in this plugin. This file is updated but does not have the latest font releases from Google.', 'woops' ),
                'type' 		=> 'heading',
           	),
           	array(
                'type' 		=> 'google_api_key',
			...
			array(
				...
				'desc' 		=> __( 'On deletion (not deactivate) the plugin will completely remove all tables and data it created, leaving no trace it was ever here.', 'woops'),
			...
			array(
           	...
           	array(
				...
				'checked_label'		=> __( 'STRICT', 'woops' ),
				'unchecked_label' 	=> __( 'BROAD', 'woops' ),
			),
