...
class WC_Predictive_Search_Input_Box_Settings extends WC_Predictive_Search_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Search Box Settings successfully saved.', 'woops' ),
				'error_message'		=> __( 'Error: Search Box Settings can not save.', 'woops' ),
				'reset_message'		=> __( 'Search Box Settings successfully reseted.', 'woops' ),
			);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
     		...
     		array(
            	'name' 		=> __( 'Dropdown Results Animation', 'woops' ),
