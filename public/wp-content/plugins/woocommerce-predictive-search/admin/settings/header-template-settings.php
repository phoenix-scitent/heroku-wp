...
class WC_Predictive_Search_Header_Template_Settings extends WC_Predictive_Search_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Header Template Settings successfully saved.', 'woops' ),
				'error_message'		=> __( 'Error: Header Template Settings can not save.', 'woops' ),
				'reset_message'		=> __( 'Header Template Settings successfully reseted.', 'woops' ),
			);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->form_key . '_settings_fields', array(
     		array(
            	'name' 		=> __( 'HEADER TEMPLATE PREMIUM', 'woops' ),
                'type' 		=> 'heading',
