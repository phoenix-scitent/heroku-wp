...
function wc_ps_get_product_categories( $parent = 0, $child_space = '', $cats_excluded = NULL ) {
	$enable_cache          = get_option( 'predictive_search_category_cache', 'yes' );
	...
	if ( ! $categories_list ) {
		...
		$categories_list = $wc_predictive_search->get_product_categories_nested( $parent, $child_space , $cats_excluded );
