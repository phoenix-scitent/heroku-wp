...
<?php if ( count( $ps_search_list ) > 0 ) { ?>
	<p class="rs_result_heading">
		<?php wc_ps_ict_t_e( 'Viewing all', __('Viewing all', 'woops') ); ?> 
		<strong><span class="ps_heading_search_in_name"><?php echo $items_search_default[$ps_current_search_in]['name']; ?></span></strong> 
		<?php wc_ps_ict_t_e( 'Search Result Text', __('search results for your search query', 'woops') ); ?> 
...
?>
	<div class="rs_result_others">
		<div class="rs_result_others_heading"><?php wc_ps_ict_t_e( 'Sort Text', __('Sort Search Results by', 'woops') ); ?></div>
<?php
